...
- Refer to the [DynamoDB Data Model Cheat Sheet](/lesson-5-assets/dynamodb-cheat-sheet.md) for examples of how to create your tables and read/write useful data for the sample applications
